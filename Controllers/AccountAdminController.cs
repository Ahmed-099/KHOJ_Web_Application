...
namespace MissingPersonIdentificationSystem.Controllers
{
    public class AccountAdminController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,PasswordHash,Phone,Address,Role")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,PasswordHash,Phone,Address,Role")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
